...
g.1 = g.1 + geom_line(data = filter(df.winners, grepl('COMEDY', genre)),
                      aes(x = year2, y = mean.us.viewers.m),alpha=0.7,size=0.5,col=col.lig.green)
...
g.2 = g.2 +
  labs(
    #x = NULL,
    y = NULL,
    plot.title = "How Viewership varies across the years for Emmy Winners",
    plot.subtitle = "Counts are in Millions",
    plot.caption = "Source: Wikipedia"
  ) 
